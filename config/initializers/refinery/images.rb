...
Refinery::Images.configure do |config|
  ...
  config.dragonfly_secret = '2d7372ce11fe3fe2c9beead1d974f2f541a1d4c147cbfcdb'
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/tk/dev/mamoru-yorukon/public/system/refinery/images"
